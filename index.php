...
<?php else: ?>
<div>
    <p>Добавте к страницам или записям произвольное поле 'title' с необходимым заголовком для вывода на главную страницу.</p>
    <p>Второе произвольное поле 'order' укажите в нем порядок сортировки.</p>
</div>
<div>
    <p>Добавте к страницам или записям произвольное поле 'title' с необходимым заголовком для вывода на главную страницу.</p>
    <p>Второе произвольное поле 'order' укажите в нем порядок сортировки.</p>
